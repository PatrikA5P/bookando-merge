...
const WorkdayModule: React.FC = () => {
  ...
  const moduleDesign = getModuleDesign('workday');

  const tabs = [
    { id: 'appointments', icon: CalendarDays, label: 'Appointments' },
    { id: 'timetracking', icon: Timer, label: 'Time Tracking' },
    { id: 'shifts', icon: Users, label: 'Shift Planner' },
    { id: 'absences', icon: Briefcase, label: 'Absences' },
    { id: 'planner', icon: Layout, label: 'Course Planner' },
  ];
    ...
    <div className="flex flex-col min-h-full">
      <ModuleLayout
        ...
        hero={{
          icon: Clock,
          title: 'Workday Hub',
          description: 'Daily Operations & HR',
