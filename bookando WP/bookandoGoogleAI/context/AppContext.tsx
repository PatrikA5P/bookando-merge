...
const initialCustomers: Customer[] = [
  { 
    ...
    status: CustomerStatus.ACTIVE, address: '123 Maple St', gender: 'Female', notes: 'VIP Client', 
    customFields: [{key: 'Allergy', value: 'Peanuts'}]
  },
  { 
    id: '2', firstName: 'Bob', lastName: 'Smith', email: 'bob.smith@example.com', phone: '+1 555-0102', 
    status: CustomerStatus.ACTIVE, address: '456 Oak Ave', gender: 'Male', customFields: []
  },
  { 
    id: '3', firstName: 'Charlie', lastName: 'Brown', email: 'charlie@example.com', phone: '+1 555-0103', 
    status: CustomerStatus.BLOCKED, address: '', gender: 'Male', notes: 'Missed 3 appointments', customFields: []
  },
  { 
    id: '4', firstName: 'Diana', lastName: 'Prince', email: 'diana@example.com', phone: '+1 555-0104', 
    status: CustomerStatus.ACTIVE, address: 'Themyscira', gender: 'Female', customFields: []
  },
];
