    ...
    <div class="p-6 border-b border-slate-200 flex justify-between items-center bg-slate-50">
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-sm text-slate-500">{{ $t('mod.academy.course_editor') }}</p>
        </div>
      </div>
      ...
      <div class="max-w-4xl mx-auto">
        <div class="bg-slate-50 border-2 border-dashed border-slate-300 rounded-xl p-12 text-center">
          <div class="flex flex-col items-center gap-4">
            ...
            <h3 class="text-lg font-bold text-slate-800">{{ $t('mod.academy.course_editor_coming_soon') }}</h3>
            <p class="text-slate-600 max-w-md">
              {{ $t('mod.academy.course_editor_description') }}
            </p>
          </div>
        </div>
      </div>
...
import { ArrowLeft as ArrowLeftIcon, Save as SaveIcon, GraduationCap as GraduationCapIcon } from 'lucide-vue-next'
