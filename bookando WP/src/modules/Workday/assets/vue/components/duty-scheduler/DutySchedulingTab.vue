<template>
  ...
  >
    <div class="ds-header">
      <div>
        <h2>{{ t('mod.workday.dutyScheduling.title') }}</h2>
        <p>{{ t('mod.workday.dutyScheduling.subtitle') }}</p>
      </div>
      <div class="ds-period">
        <label>
          {{ t('mod.workday.dutyScheduling.periodStart') }}
          <input
        ...
        <label>
          {{ t('mod.workday.dutyScheduling.periodEnd') }}
          <input
        ...
        >
          {{ t('mod.workday.dutyScheduling.generate') }}
        </button>
      </div>
    </div>
    ...
    <div class="ds-grid">
      <section class="ds-card">
        <div class="card-header">
          <h3>{{ t('mod.workday.dutyScheduling.templates') }}</h3>
          <button
            class="btn ghost"
            @click="saveTemplate"
          >
        ...
        <div class="form-grid">
          <label>
            {{ t('mod.workday.dutyScheduling.templateName') }}
            <input
          ...
          <label>
            {{ t('mod.workday.dutyScheduling.start') }}
            <input
          ...
          <label>
            {{ t('mod.workday.dutyScheduling.end') }}
            <input
          ...
          <label class="full">
            {{ t('mod.workday.dutyScheduling.days') }}
            <select
        ...
        <div class="roles-list">
          ...
          <button
            ...
            @click="addRole"
          >
            {{ t('mod.workday.dutyScheduling.addRole') }}
          </button>
        </div>
        <div class="list">
          <h4>{{ t('mod.workday.dutyScheduling.existingTemplates') }}</h4>
          <ul>
            <li
      ...
      <section class="ds-card">
        <div class="card-header">
          <h3>{{ t('mod.workday.dutyScheduling.availability') }}</h3>
          <button
            class="btn ghost"
        ...
        <div class="form-grid">
          <label>
            {{ t('mod.workday.dutyScheduling.employeeId') }}
            <input
          ...
          <label>
            {{ t('mod.workday.dutyScheduling.employeeName') }}
            <input
          ...
          <label>
            {{ t('mod.workday.dutyScheduling.roles') }}
            <input
          ...
          <label>
            {{ t('mod.workday.dutyScheduling.weeklyCapacity') }}
            <input
          ...
          <label>
            {{ t('mod.workday.dutyScheduling.unavailableDays') }}
            <select
          ...
          <label>
            {{ t('mod.workday.dutyScheduling.preferredShifts') }}
            <input
        ...
        <div class="list">
          <h4>{{ t('mod.workday.dutyScheduling.currentAvailability') }}</h4>
          <ul>
            <li
    ...
    <section class="ds-card">
      <div class="card-header">
        <h3>{{ t('mod.workday.dutyScheduling.constraints') }}</h3>
        <button
          class="btn ghost"
      ...
      <div class="rules-grid">
        <label>
          {{ t('mod.workday.dutyScheduling.maxHours') }}
          <input
        ...
        <label>
          {{ t('mod.workday.dutyScheduling.minRest') }}
          <input
        ...
        <label class="checkbox">
          <input
            ...
            type="checkbox"
          >
          {{ t('mod.workday.dutyScheduling.allowOvertime') }}
        </label>
      </div>
    </section>
    ...
    <section class="ds-card">
      <div class="card-header">
        <h3>{{ t('mod.workday.dutyScheduling.rosterTitle') }}</h3>
        <span
          v-if="state.roster?.generated_at"
          class="muted"
        >
          {{ t('mod.workday.dutyScheduling.generatedAt') }}
      ...
      >
        <thead>
          <tr>
            <th>{{ t('mod.workday.dutyScheduling.date') }}</th>
            <th>{{ t('mod.workday.dutyScheduling.shift') }}</th>
            <th>{{ t('mod.workday.dutyScheduling.role') }}</th>
            <th>{{ t('mod.workday.dutyScheduling.employee') }}</th>
            <th>{{ t('mod.workday.dutyScheduling.status') }}</th>
          </tr>
        </thead>
        <tbody>
          <tr
          ...
          >
            ...
            <td>{{ assignment.employee_name || t('mod.workday.dutyScheduling.openSlot') }}</td>
            <td>
              <span :class="['badge', assignment.status]">
                {{ assignment.status === 'assigned' ? t('mod.workday.dutyScheduling.assigned') : t('mod.workday.dutyScheduling.open') }}
              </span>
            </td>
          </tr>
        </tbody>
      ...
      <p
        ...
        class="muted"
      >
        {{ t('mod.workday.dutyScheduling.noRoster') }}
      </p>
    </section>
  </div>
  <p
