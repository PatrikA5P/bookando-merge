...
class Migration003_TimeTrackingAndShiftManagement
{
    ...
    public static function up(): bool
    {
        ...
        $columns_to_add = [
            ...
            'hours_per_day' => "DECIMAL(4,2) NULL AFTER absence_type COMMENT 'For partial days: 4.0 = half day, 8.0 = full day'",
            'affects_vacation_balance' => "TINYINT(1) DEFAULT 1 AFTER hours_per_day COMMENT 'Whether this deducts from vacation quota'",
            'requires_certificate' => "TINYINT(1) DEFAULT 0 AFTER affects_vacation_balance COMMENT 'Whether medical certificate is required'",
        ...
        $sql = "CREATE TABLE IF NOT EXISTS {$table_name} (
            ...
            year YEAR NOT NULL,
            entitled_days DECIMAL(5,2) NOT NULL DEFAULT 25.00 COMMENT 'Annual vacation entitlement',
            carried_over_days DECIMAL(5,2) DEFAULT 0.00 COMMENT 'Days carried over from previous year',
            taken_days DECIMAL(5,2) DEFAULT 0.00 COMMENT 'Days already taken (approved)',
            planned_days DECIMAL(5,2) DEFAULT 0.00 COMMENT 'Days planned (pending approval)',
        ...
        $sql = "CREATE TABLE IF NOT EXISTS {$table_name} (
            ...
            event_period_id BIGINT UNSIGNED NULL COMMENT 'Link to event_periods if shift is for a course/event',
            ...
            generated_by VARCHAR(50) NULL COMMENT 'manual, auto_scheduler, template, recurring',
            recurring_rule JSON NULL COMMENT 'For recurring shifts: {freq: weekly, interval: 1, days: [1,3,5]}',
        ...
        $sql = "CREATE TABLE IF NOT EXISTS {$table_name} (
            ...
            required_role VARCHAR(64) NULL COMMENT 'e.g. driving_instructor, yoga_trainer',
        ...
        $sql = "CREATE TABLE IF NOT EXISTS {$table_name} (
            ...
            preferred_shift_types JSON NULL COMMENT 'Array of preferred shift types',
            preferred_days JSON NULL COMMENT 'Array of preferred weekdays (1=Mon, 7=Sun)',
            blocked_days JSON NULL COMMENT 'Array of blocked weekdays',
            preferred_time_ranges JSON NULL COMMENT 'Array of {start, end} time ranges',
        ...
        $sql = "CREATE TABLE IF NOT EXISTS {$table_name} (
            id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
            tenant_id BIGINT UNSIGNED NULL,
            day_of_week TINYINT UNSIGNED NULL COMMENT '1=Monday, 7=Sunday, NULL=every day',
            ...
            location_id BIGINT UNSIGNED NULL,
            service_id BIGINT UNSIGNED NULL,
            priority INT DEFAULT 0 COMMENT 'Higher priority = scheduled first',
