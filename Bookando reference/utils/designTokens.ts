 ...
 *
 * Diese Datei enthält alle Design-Tokens für das Bookando System:
 * - Modul-spezifische Farben und Gradienten
 * - Gemeinsame Abstände, Border-Radius, Schatten
...
export function getModuleGradient(moduleName: string): string {
  ...
  // Extrahiert die Farben aus dem Tailwind gradient
  // Beispiel: 'from-blue-700 to-sky-900' -> 'linear-gradient(to right, #1d4ed8, #0c4a6e)'
  // Für die tatsächliche Verwendung sollten wir die Tailwind-Klassen verwenden
...
export const TABLE_STYLES = {
  ...
  theadAlt: 'bg-slate-100 border-b border-slate-300', // Alternative header style
  ...
  tbodyAlt: 'divide-y divide-slate-100', // Thinner dividers
  ...
  tdCompact: 'p-3 text-sm text-slate-700', // Less padding
...
export const CARD_STYLES_ADVANCED = {
  ...
  withBanner: {
    ...
    banner: 'h-24 bg-gradient-to-r relative', // Add specific gradient in component
    content: 'p-6 flex-1',
...
// ============================================================================
// HELPER FUNCTIONS FÜR CARDS & TABLES
// ============================================================================
