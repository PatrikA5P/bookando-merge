...
import {
    ...
    Layers, Star, Zap, BookOpen, CheckCircle, Video, Image as ImageIcon, Edit2, List
} from 'lucide-react';
import { useApp } from '../../../context/AppContext';
import { EducationCardTemplate, CardChapter, EducationItem, Lesson } from '../../../types';
...
const EducationCardEditor: React.FC<{ 
    ...
    // --- Structure Logic ---
    const addChapter = () => {
        const newChapter: CardChapter = { id: `c_${Date.now()}`, title: 'New Chapter', items: [] };
