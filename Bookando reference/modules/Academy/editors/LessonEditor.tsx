...
import { 
    ArrowLeft, Save, Link as LinkIcon, Video, Image as ImageIcon, FileText, Upload, Trash2, Plus, X, 
    ChevronDown, Bold, Italic, List as ListIcon, Globe, Play, File, Paperclip, Code
} from 'lucide-react';
import { ExtendedLesson, LessonGroup, StructuredAttachment } from '../../../types';
