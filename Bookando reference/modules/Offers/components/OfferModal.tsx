...
import {
    ...
    Edit2, Check, Image as ImageIcon, Video, Globe, Eye, Package, Layout, TrendingUp, BookOpen, Link as LinkIcon
} from 'lucide-react';
import { useApp } from '../../../context/AppContext';
import { 
    ServiceItem, BundleItem, VoucherItem, EventSession, PaymentOption, 
    EventStructure, VoucherType, VatRate
} from '../../../types';
...
const OfferModal: React.FC<OfferModalProps> = ({ mode, type, initialData, initialTab, availableServices, onClose, onSave }) => {
    ...
    const handleAddVatRate = () => {
        ...
        const newVatRate: VatRate = {
            ...
            type: 'Geschuldete MWST (Umsatzsteuer)', // Default
            active: true,
